      ...
      <div className="flex flex-col md:flex-row max-w-7xl mx-auto pt-24">
        ...
        <aside className="w-full md:w-64 shrink-0 md:border-r border-slate-800 md:min-h-[calc(100vh-6rem)] px-6 py-8 bg-slate-950 md:sticky md:top-24 self-start">
          ...
          <ul className="space-y-1 mb-8 border-l border-slate-800 ml-2">
            ...
            <li><Link href="/docs/synapxis#prerequisites" className="block px-4 py-1.5 text-sm text-slate-400 hover:text-teal-400 hover:border-l hover:border-teal-400 -ml-[1px] transition-all">Prerequisites</Link></li>
            <li><Link href="/docs/synapxis#installation" className="block px-4 py-1.5 text-sm text-slate-400 hover:text-teal-400 hover:border-l hover:border-teal-400 -ml-[1px] transition-all">Installation</Link></li>
