...
export default function SentinelDocs() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center border border-slate-800 rounded-2xl bg-slate-900/20 p-12">
      {/* Icon: White/Silver Shield */}
      <div className="p-6 bg-slate-900 rounded-full mb-6 border border-slate-800 shadow-lg shadow-white/10">
        <ShieldCheck className="w-12 h-12 text-white" />
      </div>
      
      <h1 className="text-3xl font-bold text-white mb-4">Sentinel Identity Manager</h1>
      ...
      <p className="text-slate-400 max-w-md leading-relaxed">
        We are currently finalizing the documentation and release build for Sentinel. 
